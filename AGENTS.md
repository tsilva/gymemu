...
- The player runs inference only on a fresh action key press. The first press after
  opening or resetting generates the initial frame; subsequent presses execute actions.
