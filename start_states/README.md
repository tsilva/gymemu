...
Breakout snapshots use held-out episode 5 from dataset revision
...
increasing downward. Upward motion was checked across the whole eight-frame stack.

| Name | Frame position | Situation |
| --- | --- | --- |
| `ball-up` | 45 | After a paddle bounce, ball moves up toward the bricks; x=53.5, y=149.5 |
| `near-bricks` | 58 | Ball still moving up, closer to the wall; x=27.5, y=110.5 |
| `paddle-approach` | 29 | Ball moves down toward paddle contact; x=85.5, y=180.5 |
