...
| Separate frameskip-1 unified MLP | Same 188-feature encoding and six 512-wide residual blocks; 179 output logits; 3,347,635 parameters | Same 119 current state/action values; training-derived one-frame output vocabulary | **99.6056%** joint validation, 3,723/943,949 errors; all 421 life losses detected with no false stops. Exact sampled 256-native-frame windows **51.83%**, versus 20.38% for the previous unified MLP. Different dataset/policies; test reserved. |
